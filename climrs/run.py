...
def main():
    sys.argv = [
        ...
        "--num_envs", "1",
        "--cfg_env", "climrs/data/cfg/humanoid_carrybox.yaml",
        "--cfg_train", "climrs/data/cfg/train/amp_humanoid_task.yaml",
        "--motion_file", "climrs/data/motions/climrs_data/climrs_data.yaml",
        "--checkpoint", "climrs/data/models/Humanoid.pth"
    ]
    global args
    global cfg
    global cfg_train
    ...
    if args.train:
        wandb.init(project="CLiMRS", name=args.wandb_name)
